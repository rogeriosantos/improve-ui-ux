...
- Then call `nice-ui-ux-v5` using the finalized color system.
- Produce consistent, modern, accessible UI/UX.
- Output updated components, Tailwind themes, tokens, or design guidelines.
